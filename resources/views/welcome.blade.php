...
<nav class="fixed top-0 left-0 w-full z-50 bg-[#1a1a1a]/80 backdrop-blur-md border-b border-stone-800 transition-all duration-300">
  <div class="flex items-center justify-between w-full px-18 py-4">
    ...
    <section id="inicio" class="bg-[#2B2928] w-full min-h-screen flex items-center pt-28 pb-20 flex flex-col md:flex-row items-stretch min-h-[70vh] mx-auto mb-20 gap-8">
        ...
        <div class="w-full md:w-1/2 flex flex-col justify-center items-start px-6 md:px-12 py-10">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="#habilidades y proyectos" class="w-full sm:w-auto px-8 py-4 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-black font-semibold text-base transition-all duration-200 shadow-xl shadow-orange-500/10 hover:scale-[1.02]">
...
<section id="habilidades y proyectos" class="max-w-4xl mx-auto px-4 py-5">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white dark:bg-stone-800/40 p-6 rounded-2xl border border-stone-200 dark:border-stone-700/50 hover:border-orange-500 transition-colors">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <span class="px-3 py-1 text-sm bg-stone-200 dark:bg-stone-900 rounded-full dark:text-stone-300 text-black">Docker / DDEV</span>
                <span class="px-3 py-1 text-sm bg-stone-200 dark:bg-stone-900 rounded-full dark:text-stone-300 text-black">Linux</span>
...
<section id="contacto" class="max-w-7xl mx-auto px-6 py-20">
  ...
  <li class="flex items-center gap-4">
    ...
    <div class="bg-stone-900/30 p-8 rounded-2xl border border-stone-800">
      ...
      <form id = "formulario" action="TU_LOGICA_AQUI" method="POST" class="flex flex-col gap-6 text-left">
    ...
    <!-- Recuadro de Redes (Versión compacta para columna derecha) -->
<div class="mt-4 border border-green-800 bg-[#2B2928] rounded-2xl p-5 md:p-6 flex flex-col 2xl:flex-row items-center justify-between gap-6 shadow-lg w-full">
    
    <!-- Lado Izquierdo: Textos -->
    <div class="w-full 2xl:w-3/5 text-center 2xl:text-left">
        <h3 class="text-green-500 text-lg font-bold mb-2">También puedes contactarme aquí ;)</h3>
    </div>

    <!-- Lado Derecho: Botones de Redes Sociales -->
    <div class="w-full 2xl:w-2/5 flex flex-row gap-3 justify-center 2xl:justify-end">
        
        <!-- Botón de GitHub -->
        <a href="https://github.com/Codeby-Davi" target="_blank" class="flex items-center justify-center gap-2 bg-neutral-800 hover:bg-neutral-700 text-white px-4 py-2.5 rounded-xl transition-all duration-300 border border-neutral-700 hover:border-neutral-500 flex-1 2xl:flex-none">
            ...
            <span class="font-semibold text-sm tracking-wide">GitHub</span>
        </a>

        <!-- Botón de LinkedIn -->
        <a href="https://www.linkedin.com/in/walter-david-guevara-seminario-b4b246375/?skipRedirect=true" target="_blank" class="flex items-center justify-center gap-2 bg-[#0077b5] hover:bg-[#005e93] text-white px-4 py-2.5 rounded-xl transition-all duration-300 shadow-[0_0_15px_rgba(0,119,181,0.3)] hover:shadow-[0_0_20px_rgba(0,119,181,0.5)] flex-1 2xl:flex-none">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
            <span class="font-semibold text-sm tracking-wide">LinkedIn</span>
        </a>
